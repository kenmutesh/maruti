...
[
'pageTitle' => 'Aprotec | Add Hardware Acquisition',
  ...
  <section class="content home">
    <div class="container-fluid">
      ...
      <div class="content">
        ...
        <form class="" onsubmit="showSpinner(event)" action="{{ route('hardware_acquisition') }}" method="post" autocomplete="off">
          @csrf
            ...
            <div class="col">
              <div class="form-group">
                ...
                @if(session()->get('auth_warehouse_uid') != 'N/A')
                  <select class="form-control searchable-select warehouse-select" required name="main_warehouse_id" onchange="filterItems(this)" data-live-search="true" data-style="text-white">
                  ...
                  <td>
                    ...
                    <select disabled style="width:200px;" name="item_id[]" class="searchable-select item-list-dropdown" onchange="prefillRowAcquisition(this)" data-live-search="true" data-style="text-white">
                      <option disabled selected>Choose from inventory</option>
                        ...
                        ?>
                          <option value="<?php echo $hardwareItem->item_id ?>" attr-data-name="<?php echo $hardwareItem->item_name ?>" attr-data-serial="<?php echo $hardwareItem->serial_no ?>" attr-data-description="<?php echo $hardwareItem->item_description ?>" attr-min-threshold="<?php echo $hardwareItem->min_threshold ?>" attr-current-quantity="<?php echo $hardwareItem->total_quantity ?>" attr-current-warehouse-id="<?php echo $hardwareItem->warehouse_id ?>" attr-current-bin-id="<?php echo $hardwareItem->bin_id ?>">
