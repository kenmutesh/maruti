...
[
'pageTitle' => 'Aprotec | Past Hardware Inventory Acquisitions',
'datatable' => true,
]
)
        ...
        <div class="col">
          <div class="card card-plain">
            <div class="card-header">
              <h4 class="card-title p-0 m-0">Hardware inventory acquisition</h4>
            </div>
            ...
            <div class="py-3 row m-0">
              ...
              <div class="table-responsive p-0">
                <table class="table table-bordered tablesorter data-table fixed-table" data-table="acquisition-list">
                  ...
                  <tbody>
                    @foreach($hardwareAcquisitions as $singleAcquisition)
                      <tr>
                        <td class="p-0">
                        ...
                        <td class="p-0">
                          <a href="/acquisition/viewdoc/{{ $singleAcquisition->id }}" target="_blank" type="button" name="button" class="btn btn-info btn-sm" >
                            PRINT
                          </a>
                      </div>
                        </td>
