...
<body class="theme-blue">
    ...
    <div class="container-fluid">
      <div class="wrapper">
        ...
        <div class="content">
          ...
          <div class="row">
            <a href="/supplier-payments/create" class="btn btn-default btn-sm d-flex align-items-center container justify-content-center mb-3 ml-3 w-25">
                  ...
                  <table class="table table-bordered sorter col-12 p-0 data-table" data-table="payment-list" id="documentFrame">
                    ...
                    <tbody>
                      ...
                      <tr class="p-0">
                        ...
                        <td class="p-0 m-0">
                          {{ number_format($payment->sum_purchase_payments, 2) }}
                        </td>
                        ...
                        <td class="p-0 m-0">
                          ...
                          @else
                          <a href="/supplier-payments/{{ $payment->id }}/edit" class="btn btn-sm btn-primary">
                            Edit
                          </a>
  ...
  <script>
    ...
    async function loadNullifyForm(paymentID){
      ...
      const request = await fetch(`/supplier-payments/nullify-form/${paymentID}`);
    ...
    async function loadDeleteForm(paymentID){
      ...
      const request = await fetch(`/supplier-payments/delete-form/${paymentID}`);
