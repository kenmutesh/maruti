              ...
              <div class="col-md-12">
                <div class="card ">
                  ...
                  <div class="card-header text-center p-0">
                    @if($date)
                    <p class="card-title p-0 m-0 font-weight-bold">A\P Aging Report As of: {{ date('d/m/Y', strtotime($date)) }}</p>
                    @else
                    <p class="card-title p-0 m-0 font-weight-bold">A\P Aging Report As of: {{ date('d/m/Y', time()) }}</p>
                    @endif
                  </div>
                    ...
                    <div class="table-responsive p-0">
                      <table class="table table-bordered sorter fixed-table col-12 table-fixed-2 p-0 data-table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="p-0">{{ $supplier->supplier_name }}</td>
                            <td class="p-0">
                              {{ number_format($supplier->current_balance ,2) }}
                            </td>
                            <td class="p-0">
                              {{ number_format($supplier->thirty_day_balance ,2) }}
                            </td>
                            <td class="p-0">
                              {{ number_format($supplier->sixty_day_balance ,2) }}
                            </td>
                            <td class="p-0">
                              {{ number_format($supplier->ninety_day_balance ,2) }}
                            </td>
                            <td class="p-0">
                              {{ number_format($supplier->over_ninety_day_balance,2) }}
                            </td>
                          </tr>
                          @endforeach
                        </tbody>                        
