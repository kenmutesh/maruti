            ...
            <div class="wrapper">
                <div class="main-panel">
                    ...
                    <div class="content">
                        ...
                        <form onsubmit="showSpinner(event)" action="{{ route('cashsales.direct.store') }}" method="post" autocomplete="off">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <input class="col-6 form-control" type="text" name="cu_number_prefix" value="{{ $cashsale->next_cu_prefix }}">
                                            <input class="col-6 form-control" type="number" step=".1" name="cu_number_suffix" value="{{ $cashsale->next_cu_suffix }}">
                                        </div>
                                    </div>
                                </div>
