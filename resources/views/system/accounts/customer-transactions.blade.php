                        ...
                        <div class="col">
                            <div class="card card-plain p-0">
                                <div class="card-header p-0">
                                    <h4 class="card-title m-0 p-0">Customer Transactions</h4>
                                </div>
                                <div class="card-body p-0">
                                    <div class="row justify-content-between">
                                        <div class="col-sm-12 p-0">
                                            <div class="py-1 row m-0">
                                                <div class="d-flex justify-content-around col-sm-4 p-0 customer-list filters">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="text-center mx-2">
                                                        ...
                                                        <select onchange="resetOptions(this)" class="form-control" data-live-search="true" data-style="text-white">
                                                            ...
                                                            <option value="{{ $singleCustomer->customer_name }}" data-tokens="{{ $singleCustomer->customer_name }}">
                                            ...
                                            <div class="table-responsive overflow-auto px-1 pt-1">
                                                <table class="table table-bordered sorter fixed-table col-12 table-fixed-2 p-0 data-table" data-table="customer-list">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="p-0">Reference</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach($recordsArray as $record)
                                                        <tr data-customer-id="{{ $record['customer_id'] }}">
                                                            <td class="p-0">{{ $record['date'] }}</td>
                                                            <td class="p-0">{{ $record['customer_name'] }}</td>
                                                            <td class="p-0">{{ $record['type'] }}</td>
                                                            <td class="p-0">{{ $record['amount']  }}</td>
                                                            <td class="p-0">{{ $record['id'] }}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
