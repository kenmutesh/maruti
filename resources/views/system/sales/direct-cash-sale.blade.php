            ...
            <div class="wrapper">
                <div class="main-panel">
                    ...
                    <div class="content">
                        ...
                        <form class="" onsubmit="showSpinner(event)" action="{{ route('direct_cash_sale') }}" method="post" autocomplete="off">
                            @csrf
                            ...
                            <button type="submit" name="submit_btn" value="Create Cash Sale" class="btn btn-success text-white w-100 rounded-pill my-4">CREATE CASH SALE</button>
