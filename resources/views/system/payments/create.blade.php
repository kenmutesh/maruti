...
<body class="theme-blue">
            ...
            <div class="col">
              <div class="card card-plain">
                ...
                <div class="card-body p-0">
                  <form onsubmit="showSpinner(event)" method="POST" autocomplete="off" action="{{ route('payments.store') }}">
                    @csrf
                      ...
                      <div class="row">
                        <div class="col-sm-5 position-relative mr-5">
                          <div class="form-group">
                            ...
                            <select onchange="searchCustomerInvoices(this)" class="form-control ms searchable-select customer-select" data-live-search="true" data-style="rounded-sm text-white m-0" required name="customer_id">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group row align-items-center">
                            ...
                            <select name="payment_mode" id="" class="form-control searchable-select ms">
                          ...
                          <table class="table table-bordered text-center">
                            ...
                            <tbody class="invoice-body">
                              <tr class="placeholder">
                                <td colspan="100%">Choose customer first</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
  ...
  <script type="text/javascript">
    ...
    async function searchCustomerInvoices(selectElement) {
      ...
      debounce(async () => {
        ...
        const customerInvoicesRequest = await fetch(`/customers/invoices/${selectElement.value}`);
