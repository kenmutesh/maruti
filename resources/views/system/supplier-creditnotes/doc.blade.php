    ...
    <div class="row">
      <div class="col-12 d-flex justify-content-between">
        ...
        <div class="col-auto d-flex flex-column text-nowrap" style="color:#000;border:1px solid #ff6600;height:max-content;">
          <span class="font-weight-bold" style="width:auto;font-size:12px;">SUPPLIER: {{ $creditNote->supplier->supplier_name }}</span>
          <span style="color:#000;width:auto;font-size:12px;">PIN: {{ $creditNote->supplier->company_pin }}</span>
          <span style="color:#000;width:auto;font-size:12px;">EMAIL: {{ $creditNote->supplier->supplier_email }}</span>
          <span style="color:#000;width:auto;font-size:12px;">TEL: {{ $creditNote->supplier->supplier_mobile }}</span>
          <span style="width:auto;font-size:12px">
            NO: <b>{{ $creditNote->supplier_credit_note_prefix }}{{ $creditNote->supplier_credit_note_suffix }}</b>
          </span>
          <span style="width:auto;font-size:12px">
      ...
      <table class="col-sm-11 mx-auto" style="border-collapse:collapse;font-size:12px;">
        ...
        <tbody>
          ...
          <tr style="color:#000;">
            ...
            @elseif($item->non_inventory_item_id)
