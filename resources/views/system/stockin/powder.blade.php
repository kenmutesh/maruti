  ...
  <div class="wrapper">
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <form class="" onsubmit="showSpinner(event)" action="{{ route('stock_in_powder') }}" method="post" autocomplete="off" class="container" enctype="multipart/form-data">
          @csrf
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select class="form-control searchable-select ms supplier-select" required name="supplier_id">
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                ...
                @endif
                <select class="form-control searchable-select ms warehouse-select" required name="warehouse_id" onchange="filterFloors(this)">
            ...
            <div class="col">
              <div class="form-group">
                ...
                <select class="form-control searchable-select ms floor-select" required name="floor_id" onchange="filterShelves(this)">
                </select>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                ...
                <select class="form-control searchable-select ms shelf-select" required name="shelf_id" onchange="filterBins(this)">
                </select>
              </div>
            </div>
            ...
            <?php
              if ($powderItem->supplier == true) {
                ...
                <div class="col-sm-6 form-group">
                  ...
                  <input type="date" required name="manufacture_date" class="form-control dark-text">
                </div>

                <div class="col-sm-6 form-group">
                  <label>Expiry Date</label>
                  <input type="date" required name="expiry_date" class="form-control dark-text">
                </div>

                <div class="col-sm-6 form-group">
                  <label>Batch Number</label>
                  <input type="text" required name="batch_no" class="form-control dark-text">
                </div>
          ...
          <button type="submit" name="submit_btn" value="RECORD STOCK IN" class="btn btn-success text-white w-100 mx-auto">
            RECORD STOCK IN
          </button>
                  ...
                  <div class="d-flex flex-column">
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <select required name="floor_id" class="form-control col-sm-12 w-100 floor-select searchable-select" id="floorID">
                            @foreach($floors as $singleFloor)
                              <option value="{{ $singleFloor->id }}">
                                {{ $singleFloor->floor_name }}
                              </option>
                            @endforeach
                        </select>
                      </div>
