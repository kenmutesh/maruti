@include('universal-layout.header', ['pageTitle' => 'Aprotec | Goods Returned Note Document'])
...
<body class="bg-secondary">
  ...
  <div class="row d-flex justify-content-around w-75 mx-auto">
    <button type="button" name="button" onclick="printInfo('AP Credit Note:{{ $creditNote->date_created }}.pdf')" class="btn btn-info col-sm-3">
      SAVE TO LOCAL
    </button>
...
<div class="col-sm-12 mt-3 mx-auto h-100" style="width:100%;background:white;min-height:29cm;" id="documentFrame" style="background:white;font-family:'Helvetica';font-weight: lighter;">
  <h3 class="text-center">GOODS RETURNED NOTE</h3>
  ...
  <div class="row mt-4">
    <table class="col-sm-11 mx-auto" style="border-collapse:collapse;border:1px solid #ff6600;font-size:14px;">
      <thead style="background:#ff6600;color:white;">
        <th style="border-right:1px solid #fff;">Item Name/Color</th>
        <th style="border-right:1px solid #fff;">Item Description</th>
        <th style="border-right:1px solid #fff;">Quantity</th>
        <th style="border-right:1px solid #fff;">KG</th>
        <th style="border-right:1px solid #fff;">Unit Cost</th>
      ...
      <tfoot>
        <tr>
          <td style="border:1px solid #ff6600;color:#000;text-align:center;padding:5px;" colspan="5">Grand Total</td>
          <td style="background:#ff6600;color:white;padding:5px;">{{ number_format($creditNote->grand_total, 2) }}</td>
        </tr>
      </tfoot>
    </table>
  </div>
