                          ...
                          <tr>
                            ...
                            <td class="p-0">
                              @if($creditNote->invoice_id)
                                <span>{{ $creditNote->invoice->invoice_prefix }}{{ $creditNote->invoice->invoice_suffix }}</span>
                              @endif
                            </td>
                            <td class="p-0">
                              <a href="/customercreditnotes/{{ $creditNote->id }}" target="_blank" type="button" name="button" class="btn btn-info btn-sm">
                                VIEW DOC
                              </a>
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <form onsubmit="showSpinner(event)" method="POST" autocomplete="off" action="{{ route('customercreditnotes.destroy', $creditNote->id ) }}">
                                          @csrf
                                          @method("DELETE")
