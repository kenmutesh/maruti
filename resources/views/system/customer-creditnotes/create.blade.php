      ...
      <div class="wrapper">
        <div class="main-panel">
          ...
          <div class="content">
            ...
            <form class="" onsubmit="showSpinner(event)" action="{{ route('customercreditnotes.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
              @csrf
              <div class="row">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <select name="customer_id" class="form-control ms search-select" onchange="updateInvoices(this)">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <select name="invoice_id" class="form-control ms search-select invoice-select">
          ...
          <script type="text/javascript">
            async function updateInvoices(selectElement) {
              const invoiceList = document.querySelector('.invoice-select');
              invoiceList.innerHTML = '';
              $(invoiceList).select2('destroy');
              const customerID = selectElement.value;

              const request = await fetch(`/customers/creditnotes/invoices/${customerID}`);
              if (request.ok) {
                invoiceList.innerHTML = await request.text();
              } else {
                invoiceList.innerHTML = "<option disabled>Failed in getting data</option>";
              }
              $(invoiceList).select2();
            }
