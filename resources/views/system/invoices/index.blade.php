            ...
            <div class="col">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="card-title m-0 p-0">Invoices Upto {{ date('d/m/Y', time()) }}</h4>
                </div>
                  ...
                  <div class="row justify-content-between">
                    ...
                    <div class="col-sm-4 text-center">
                      <div class="dropdown">
                        ...
                        @forelse ($allInvoices as $singleInvoiceBatch)
                            <li class="dropdown-item d-flex align-items-baseline">
                              <?php $invoiceSection = ''; ?>
                              @foreach ($singleInvoiceBatch as $singleInvoice)
                                @if ($loop->first)
                                  <?php $invoiceSection .= '/'.$singleInvoice->invoice_suffix; ?>
                                ...
                                @endif
                              @endforeach 
                              <a href="/invoices/sections{{ $invoiceSection }}" class="btn btn-primary btn-sm py-0 px-2">View</a>                      
                            </li>
                        @empty
                        <li><a class="dropdown-item"  href="#">No invoices present</a></li>
                        @endforelse
                        </div>
                      </div>
                    </div>
