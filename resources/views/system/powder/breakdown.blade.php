                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header row justify-content-between p-0">
                                        <h4 class="card-title p-0 m-0 col-12 text-center">Powder Breakdown</h4>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <p class="p-0 m-0">COLOR: {{ $powder->powder_color }}</p>
                                                <p class="p-0 m-0">SUPPLIER: {{ $powder->supplier->supplier_name }}</p>
                                        ...
                                        <div class="table-responsive powderInventory" id="powderInventory">
                                            <table class="table tablesorter table-bordered">
                                                ...
                                                <tbody class="list">
                                                    <tr>
                                                        <td class="p-0">Opening Weight</td>
                                                        <td class="p-0"></td>
                                                        <td class="p-0">{{ number_format($openingWeight, 2) }}</td>
                                                    </tr>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td class="p-0">Final weight</td>
                                                        <td class="p-0"></td>
                                                        <td class="p-0">{{ $powder->current_weight }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="100%">
