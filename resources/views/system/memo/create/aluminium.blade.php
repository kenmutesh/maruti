  ...
  <div class="wrapper">
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <form class="" onsubmit="showSpinner(event)" action="{{ route('stock_in_aluminium_memo') }}" method="post" autocomplete="off" class="container" enctype="multipart/form-data">
          @csrf
          <div class="row">
          ...
          <div class="row mx-auto mt-5 text-center">
            ...
            <?php
              ...
              ?>
              <p class="col-sm-12">Default Supplier: <?php echo $aluminiumItem->supplier->supplier_name ?></p>
              ...
              <div class="col-sm-6 form-group">
                <label>Serial Number</label>
                <input type="text" required name="serial_number" readonly value="<?php echo $aluminiumItem->serial_no ?>" class="form-control dark-text">
              </div>

              <div class="col-sm-6 form-group">
                <label>Quantity Tag</label>
                <input type="text" required name="quantity_tag" readonly value="<?php echo $aluminiumItem->quantity_tag ?>" class="form-control dark-text">
              </div>


              <div class="col-sm-6 form-group">
                <label>Weight of Good</label>
                <input type="text" readonly value="<?php echo $aluminiumItem->goods_weight ?>" required name="good_weight" class="form-control dark-text">
              </div>

              <input type="hidden" name="supplier_id" value="<?php echo $aluminiumItem->supplier->id ?>">

              <div class="col-sm-6 form-group">
                <label>Stocked in quantity</label>
                <input type="text" required name="stocked_quantity" onkeyup="checkMaxLimit(this)" attr-max-threshold="<?php echo $aluminiumItem->max_threshold + $aluminiumItem->current_weight ?>" class="form-control dark-text">
              </div>

              <div class="col-sm-6 form-group">
                <label>Minimum Threshold</label>
                <input type="text" required name="min_threshold" readonly value="<?php echo $aluminiumItem->min_threshold ?>" onblur="checkMinThreshold(this)" class="form-control dark-text">
              </div>

              <div class="col-sm-6 form-group">
                <label>Maximum Threshold</label>
                <input type="text" onblur="checkMaxThreshold(this)" readonly value="<?php echo $aluminiumItem->max_threshold ?>" required name="max_threshold" class="form-control dark-text">
              </div>

              <div class="col-sm-6 form-group">
                <label>Unit Cost</label>
                <input type="text" required name="unit_cost" readonly value="<?php echo $aluminiumItem->standard_cost ?>" class="form-control dark-text">
              </div>

              <div class="col-sm-6 form-group">
                <label>Item Price</label>
                <input type="text" required name="item_price" readonly value="<?php echo $aluminiumItem->item_price ?>" onkeyup="updateTaxedPrice(this)" class="form-control dark-text">
              </div>

              <div class="col-sm-6 form-group">
                <label>Item Tax(%)</label>
                <input type="text" required name="item_tax" readonly value="<?php echo $aluminiumItem->tax ?>" onkeyup="updateTaxedPrice(this)" class="form-control dark-text">
              </div>

              <div class="col-sm-6 form-group">
                <label>Price + Tax(%)</label>
                <input type="text" readonly required name="taxed_price" readonly value="<?php echo $aluminiumItem->taxed_price ?>" class="form-control dark-text">
              </div>
